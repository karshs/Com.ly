...
const PIE_COLORS = ['#0b4ec7', '#2563eb', '#60a5fa', '#cbd5e1'];
                  ...
                  <AreaChart data={timeseries} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                    <defs>
                      <linearGradient id="clicksGradient" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="#0b4ec7" stopOpacity={0.25} />
                        <stop offset="95%" stopColor="#0b4ec7" stopOpacity={0} />
                      </linearGradient>
                    </defs>
                ...
                {referrers.length === 0 ? (
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip />
                      <Bar dataKey="count" fill="#0b4ec7" radius={[0, 4, 4, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                )}
              </div>
